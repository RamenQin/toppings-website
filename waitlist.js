...
function submit_email_to_waitlist() {
    ...
    {
    current_url = "https://www.toppingsapp.com?&ref_id="+document.getElementById('referral_code').value; //fetch current URL, including potential referral token
    }
    ...
    const success_callback = function (response) {
        ...
        $("#userSubmit").hide()
        $("#waitlistSpot").attr("style", "display: contents")
